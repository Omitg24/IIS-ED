 ...
 */	
	/**
	 * Test que comprueba que la potencia recursiva de 2 elevado a 3
	 */
	@Test
	void testPow2Rec11() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva de 2 elevado a 6 es 64
	 */
	@Test
	void testPow2Rec12() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva de 2 elevado a 10 es 1024
	 */
	@Test
	void testPow2Rec13() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva de 2 elevado a 15 es 32768
	 */
	@Test
	void testPow2Rec14() {		
		Algorithms alg= new Algorithms();
 ...
 */	
	...
	void testPotenciaRec4() {		
		Algorithms alg= new Algorithms();
		assertEquals(1679616, alg.potenciaRec(6,8));
	}
...
/**
 * Pruebas del metodo Pow2It1
 */
	/**
	 * Test que comprueba que la potencia iterativa de 2 elevado a 6 es 64
	 */
	@Test
	void testPow2It1() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia iterativa de 2 elevado a 10 es 1024
	 */
	@Test
	void testPow2It2() {		
		Algorithms alg= new Algorithms();
		assertEquals(1024, alg.pow2Iter(10));
	}	
	/**
	 * Test que comprueba que la potencia iterativa de 2 elevado a 15 es 32768
	 */
	@Test
	void testPow2It3() {		
		Algorithms alg= new Algorithms();
		assertEquals(32768, alg.pow2Iter(15));
	}
	/**
	 * Test que comprueba que la potencia iterativa de 2 elevado a 20 es 1048576
	 */
	@Test
	void testPow2It4() {		
		Algorithms alg= new Algorithms();
		assertEquals(1048576, alg.pow2Iter(20));
	}	
	/**
	 * Test que comprueba que la potencia iterativa de 2 elevado a 60 es 1152921504606846976
	 */
	@Test
	void testPow2It5() {		
		Algorithms alg= new Algorithms();
		assertEquals(1152921504606846976l, alg.pow2Iter(60));
	}

/*
 * Pruebas del método pow2Rec2:
 */	
	/**
	 * Test que comprueba que la potencia recursiva 2 de 2 elevado a 3 es 8
	 */
	@Test
	void testPow2Rec21() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva 2 de 2 elevado a 6 es 64
	 */
	@Test
	void testPow2Rec22() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva 2 de 2 elevado a 8 es 256
	 */
	@Test
	void testPow2Rec23() {		
		Algorithms alg= new Algorithms();
		assertEquals(256, alg.pow2Rec2(8));
	}
	/**
	 * Test que comprueba que la potencia recursiva 2 de 2 elevado a 10 es 1024
	 */
	@Test
	void testPow2Rec24() {		
		Algorithms alg= new Algorithms();
		assertEquals(1024, alg.pow2Rec2(10));
	}
	
/*
 * Pruebas del método pow2Rec3:
 */	
	/**
	 * Test que comprueba que la potencia recursiva 3 de 2 elevado a 6 es 64
	 */
	@Test
	void testPow2Rec31() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva 3 de 2 elevado a 20 es 1048576
	 */
	@Test
	void testPow2Rec32() {		
		Algorithms alg= new Algorithms();
		assertEquals(1048576, alg.pow2Rec3(20));
	}
	/**
	 * Test que comprueba que la potencia recursiva 3 de 2 elevado a 25 es 33554432
	 */
	@Test
	void testPow2Rec33() {		
		Algorithms alg= new Algorithms();
		assertEquals(33554432, alg.pow2Rec3(25));
	}
	/**
	 * Test que comprueba que la potencia recursiva 3 de 2 elevado a 30 es 1073741824
	 */
	@Test
	void testPow2Rec34() {		
		Algorithms alg= new Algorithms();
		assertEquals(1073741824, alg.pow2Rec3(30));
	}
	
/*
 * Pruebas del método pow2Rec4:
 */	
	/**
	 * Test que comprueba que la potencia recursiva 4 de 2 elevado a 6 es 64
	 */
	@Test
	void testPow2Rec41() {		
		Algorithms alg= new Algorithms();
	...
	/**
	 * Test que comprueba que la potencia recursiva 4 de 2 elevado a 12 es 4096
	 */
	@Test
	void testPow2Rec42() {		
		Algorithms alg= new Algorithms();
		assertEquals(4096, alg.pow2Rec3(12));
	}
	/**
	 * Test que comprueba que la potencia recursiva 4 de 2 elevado a 24 es 16777216
	 */
	@Test
	void testPow2Rec43() {		
		Algorithms alg= new Algorithms();
		assertEquals(16777216, alg.pow2Rec3(24));
	}
	/**
	 * Test que comprueba que la potencia recursiva 4 de 2 elevado a 48 es 281474976710656
	 */
	@Test
	void testPow2Rec44() {		
		Algorithms alg= new Algorithms();
		assertEquals(281474976710656l, alg.pow2Rec3(48));
	}
}
