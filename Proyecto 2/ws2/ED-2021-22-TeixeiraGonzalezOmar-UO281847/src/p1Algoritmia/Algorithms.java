...
public class Algorithms {
	...
	/**
	 * Método que se usa para generar el fichero de potencia de 2 parametros
	 * 
	 * @param exp, exponente
	 * @return potencia
	 */
	...
	/**
	 * Método que se usa para generar el fichero de resto de la division de 2 parametros
	 * 
	 * @param dividendo, dividento de la division
	 * @return resto
	 */
	public int restoDivForTest(int dividendo) {
		int divisor = 5;
		return restoDivRec(dividendo, divisor);
	}
	...
	/**
	 * Método que se usa para generar el fichero de division entera de 2 parametros
	 * 
	 * @param dividendo, dividento de la division
	 * @return division entera
	 */
	public int divEntForTest(int dividendo) {
		int divisor = 5;
		return divEntRec(dividendo, divisor);
	}
	...
	public void logarithmic(int n) { // Algoritmo con una complejidad temporal logarítmica en cualquier base 
		...
		while (n>0) {
			doNothing();
			n=n/2;
			System.out.println(n + " cada vez se acerca más a 0");
		}
	} 	
